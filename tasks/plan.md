...
1. Añadir pruebas de resolución de categorías, portada breve y selector interactivo.
2. Implementar metadatos de categorías y constructores puros en `plugins/main-menu.js`.
3. Enrutar `.menu`, `.menu <categoría>` y `.allmenu` sin spam, sin tocar `handler.js` ni `self`.
