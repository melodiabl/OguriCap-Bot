...
import { X, User, Phone, ArrowLeft, CheckCircle, AlertCircle } from 'lucide-react';
...
export const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({ isOpen, onClose }) => {
  ...
  const [formData, setFormData] = useState({ username: '', whatsapp_number: '' });
  const [result, setResult] = useState<{ tempPassword?: string; username?: string; expiresIn?: string } | null>(null);
          ...
          >
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center text-sm"><span className="px-4 bg-dark-900 text-gray-500">o</span></div>
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Ingresa el número sin espacios ni símbolos</p>
                  </div>
            ...
            {step === 'success' && result && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="text-center">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">¡Contraseña Temporal Generada!</h3>
                <p className="text-gray-400 mb-6 text-sm">
                ...
                <div className="p-4 rounded-xl bg-primary-500/10 border border-primary-500/20 mb-6">
                  ...
                  <div className="text-2xl font-mono font-bold text-white tracking-wider">{result.tempPassword}</div>
                  <p className="text-xs text-gray-400 mt-2">Válida por {result.expiresIn || '24 horas'}</p>
                </div>
