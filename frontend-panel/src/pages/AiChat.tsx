...
export const AiChat: React.FC = () => {
  ...
  const sendMessageMutation = useMutation(
    (message: string) => apiService.sendChatMessage(selectedSession || '', message, aiConfig.model, aiConfig.temperature, aiConfig.maxTokens),
    {
      onSuccess: () => {
              ...
              {selectedSession && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-500 text-xs">
                    T: {aiConfig.temperature} | Max: {aiConfig.maxTokens}
                  </span>
                </div>
              )}
            </h3>
              ...
              <div className="space-y-4 h-96 flex flex-col">
                ...
                <div className="flex items-end gap-3">
                  <textarea
                    ...
                    rows={2}
                    className="flex-1 p-3 bg-gray-800/80 border border-white/10 rounded-xl text-gray-100 placeholder-gray-400 focus:border-violet-500/50 resize-none transition-all"
                  />
                  <AnimatedButton
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <CustomSelect 
                      ...
                      options={[
                        { value: 'gpt-3.5-turbo', label: 'GPT-3.5 Turbo (Delirius)' },
                        { value: 'gpt-4', label: 'GPT-4 (Delirius)' },
                        { value: 'gemini', label: 'Gemini (ZenzXZ)' },
                        { value: 'claude', label: 'Claude (ZenzXZ)' },
                        { value: 'luminai', label: 'LuminAI (ZenzXZ)' },
                        { value: 'qwen', label: 'Qwen (ZenzXZ)' }
                      ]}
                      placeholder="Seleccionar modelo"
                    />
                  </div>
                  <div>
                    <label className="text-sm text-gray-400 mb-2 block">Temperatura ({aiConfig.temperature})</label>
                    <input
                      type="range"
                      min="0"
                      max="2"
                      ...
                      className="w-full p-3 bg-gray-800/80 border border-white/10 rounded-xl text-gray-100 focus:border-violet-500/50 transition-all"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 bg-gray-800/80 border border-white/10 rounded-xl text-gray-100 focus:border-violet-500/50 transition-all"
                    />
                    <p className="text-xs text-gray-500 mt-1">Controla la longitud máxima de la respuesta</p>
                  </div>
                </div>
