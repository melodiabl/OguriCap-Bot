                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <CustomSelect
                      ...
                      onChange={(value) => setNewPedido({ ...newPedido, tipo: value })}
                      options={[
                  ...
                  <div>
                    ...
                    <CustomSelect
                      ...
                      onChange={(value) => setNewPedido({ ...newPedido, prioridad: value })}
                      options={[
                        { value: 'baja', label: '🟢 Baja - Cuando sea posible' },
                        { value: 'media', label: '🟡 Media - Prioridad normal' },
