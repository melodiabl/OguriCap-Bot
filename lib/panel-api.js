      ...
      if (pathname.startsWith('/api/auth/') && (method === 'POST' || method === 'GET')) {
        try {
          ...
          if (pathname === '/api/auth/login' && method === 'POST') {
            ...
            // No necesitamos guardar explícitamente, la base de datos global se guarda automáticamente
          ...
          if (pathname === '/api/auth/register' && method === 'POST') {
            ...
            // Guardar cambios - La base de datos global se guarda automáticamente
