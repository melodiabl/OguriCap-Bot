      ...
      if (pathname.startsWith('/api/auth/') && (method === 'POST' || method === 'GET')) {
        try {
          ...
          if (pathname === '/api/auth/login' && method === 'POST') {
            ...
            const turnstileSecretKey = process.env.TURNSTILE_SECRET_KEY || '0x4AAAAAACfeWl9wWJquOD7KLEENeQFd2Sk';
            try {
              ...
              if (!turnstileData.success) {
                return json(res, 401, { error: 'Verificación de Turnstile fallida. Intenta de nuevo.' });
              }
