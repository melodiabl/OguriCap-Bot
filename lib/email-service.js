 ...
 */
export async function sendAdminNewUserNotification({ adminEmail, username, email, ip, userAgent }) {
  const brand = getBrandConfig()
 ...
 */
export async function sendAdminPasswordChangeNotification({ adminEmail, username, email, ip }) {
 ...
 */
export async function sendAdminPasswordResetRequestNotification({ adminEmail, username, email, ip }) {
 ...
 */
export async function sendAdminBruteForceAlert({ adminEmail, email, ip, attemptCount }) {
 ...
 */
export async function sendAdminAccountDeletionNotification({ adminEmail, username, email, ip }) {
 ...
 */
export async function sendAdminRoleChangeNotification({ adminEmail, targetUsername, targetEmail, oldRole, newRole, changedBy }) {
 ...
 */
export async function sendAdminSuspiciousActivityAlert({ adminEmail, username, email, activity, ip, reason }) {
 ...
 */
export async function sendAdminDailySummary({ adminEmail, stats }) {
  const brand = getBrandConfig()
