  ...
  async createBackup(options = {}) {
    ...
    try {
      ...
      await notificationSystem.send({
        ...
        message: `Backup ${backupId} creado exitosamente (${this.formatSize(manifest.size)})`,
        category: 'system',
        data: { 
          backupId, 
          size: manifest.size, 
      ...
      await notificationSystem.send({
        ...
        message: `Falló la creación del backup: ${error.message}`,
        category: 'system',
  ...
  async restoreBackup(backupId, options = {}) {
    ...
    try {
      ...
      await notificationSystem.send({
        ...
        message: `Restaurando backup ${backupId}`,
        category: 'system',
        data: { backupId }
      });
      ...
      await notificationSystem.send({
        ...
        message: `Falló la restauración del backup: ${error.message}`,
        category: 'system',
        data: { backupId, error: error.message }
      });
