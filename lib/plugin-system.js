...
class PluginSystem extends EventEmitter {
  ...
  async loadPluginCode(plugin) {
    ...
    try {
      ...
      // Por ahora, simplemente marcar como cargado sin Worker
      // TODO: Implementar sandbox seguro en el futuro
      console.log(`[Plugin System] Plugin ${plugin.id} loaded (sandbox disabled)`)
  ...
  async activatePlugin(pluginId) {
    ...
    try {
      ...
      // Por ahora, simplemente marcar como activo
      // TODO: Implementar activación real del plugin
      console.log(`[Plugin System] Plugin ${plugin.id} activated (simplified mode)`)
  ...
  async deactivatePlugin(pluginId) {
    ...
    try {
      // Simplificar desactivación
      console.log(`[Plugin System] Deactivating plugin ${plugin.id}`)
